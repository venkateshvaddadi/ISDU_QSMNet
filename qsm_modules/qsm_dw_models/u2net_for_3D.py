...
### U^2-Net small ###
class U2NETP_for_3D(nn.Module):

    def __init__(self,in_ch=1,out_ch=1):
        super(U2NETP_for_3D,self).__init__()
...
# model=U2NETP_for_3D().float().cuda()
# model=model.eval()
...
# torch.save(model.state_dict(), 'U2NETP_for_3D.pth')
#%%
...
class U2NETP_for_3D_cus_ch(nn.Module):
    ...
    def __init__(self,in_ch=2,out_ch=2,cus_ch=64,mid_ch=16):
        super(U2NETP_for_3D_cus_ch,self).__init__()
        self.lambda_val = torch.nn.Parameter(torch.Tensor([0.5]), requires_grad = True)
        self.p=torch.nn.Parameter(torch.Tensor([2]), requires_grad = False)
    ...
    def forward(self,x):
        ...
        #print(torch.cat((d1,d2,d3,d4,d5,d6),1).shape)
        return d0#,d1,d2,d3,d4,d5,d6
 
### U^2-Net with UNET3+ style  ###
### however we dont append. we will add the different scale features.  ###

class U2NETP_in_UNET3_PLUS_style_for_3D(nn.Module):

    def __init__(self,in_ch=1,out_ch=1,cus_ch=64,mid_ch=16):
        super(U2NETP_in_UNET3_PLUS_style_for_3D,self).__init__()

        self.stage1 = RSU7_for_3D(in_ch,16,cus_ch)
        self.pool12 = nn.MaxPool3d(2,stride=2,ceil_mode=True)

        self.stage2 = RSU6_for_3D(cus_ch,16,cus_ch)
        self.pool23 = nn.MaxPool3d(2,stride=2,ceil_mode=True)

        self.stage3 = RSU5_for_3D(cus_ch,16,cus_ch)
        self.pool34 = nn.MaxPool3d(2,stride=2,ceil_mode=True)

        self.stage4 = RSU4_for_3D(cus_ch,16,cus_ch)
        self.pool45 = nn.MaxPool3d(2,stride=2,ceil_mode=True)

        self.stage5 = RSU4F_for_3D(cus_ch,16,cus_ch)
        self.pool56 = nn.MaxPool3d(2,stride=2,ceil_mode=True)

        self.stage6 = RSU4F_for_3D(cus_ch,16,cus_ch)

        # decoder
        self.stage5d = RSU4F_for_3D(cus_ch,16,cus_ch)
        self.stage4d = RSU4_for_3D(cus_ch,16,cus_ch)
        self.stage3d = RSU5_for_3D(cus_ch,16,cus_ch)
        self.stage2d = RSU6_for_3D(cus_ch,16,cus_ch)
        self.stage1d = RSU7_for_3D(cus_ch,16,cus_ch)
    ...
    def forward(self,x):
        ...
        # Converting 1->5
        ###print('Stage 5')
        decoder_input_1_to_5=nn.MaxPool3d(16,stride=16,ceil_mode=True)(hx1)
        decoder_input_2_to_5=nn.MaxPool3d(8,stride=8,ceil_mode=True)(hx2)
        decoder_input_3_to_5=nn.MaxPool3d(4,stride=4,ceil_mode=True)(hx3)
        decoder_input_4_to_5=nn.MaxPool3d(2,stride=2,ceil_mode=True)(hx4)
        decoder_input_5_to_5=hx5
        decoder_input_6_to_5=_upsample_like_for_3D(hx6,hx5)


        ###print(decoder_input_1_to_5.shape)
        ###print(decoder_input_2_to_5.shape)
        ###print(decoder_input_3_to_5.shape)
        ###print(decoder_input_4_to_5.shape)
        ###print(decoder_input_5_to_5.shape)
        ###print(decoder_input_6_to_5.shape)

        stage5d_input=hx5+decoder_input_1_to_5+decoder_input_2_to_5+decoder_input_3_to_5+decoder_input_4_to_5+decoder_input_6_to_5
        ###print('stage5d_input.shape',stage5d_input.shape)

        hx5d = self.stage5d(stage5d_input)
        ###print('hx5d.shape:',hx5d.shape)
        ###print("#"*50)

        ###print('Stage 4')
        decoder_input_1_to_4=nn.MaxPool3d(8,stride=8,ceil_mode=True)(hx1)
        decoder_input_2_to_4=nn.MaxPool3d(4,stride=4,ceil_mode=True)(hx2)
        decoder_input_3_to_4=nn.MaxPool3d(2,stride=2,ceil_mode=True)(hx3)
        decoder_input_4_to_4=hx4
        decoder_input_5_to_4=_upsample_like_for_3D(hx5d,hx4)
        decoder_input_6_to_4=_upsample_like_for_3D(hx6,hx4)


        ###print(decoder_input_1_to_4.shape)
        ###print(decoder_input_2_to_4.shape)
        ###print(decoder_input_3_to_4.shape)
        ###print(decoder_input_4_to_4.shape)
        ###print(decoder_input_5_to_4.shape)
        ###print(decoder_input_6_to_4.shape)
        ...
        stage4d_input=hx4+decoder_input_1_to_4+decoder_input_2_to_4+decoder_input_3_to_4+decoder_input_5_to_4+decoder_input_6_to_4
        ###print('stage4d_input.shape',stage4d_input.shape)
        hx4d = self.stage4d(stage4d_input)
        ###print('hx4d.shape:',hx4d.shape)
        ###print("#"*50)

        ###print('Stage 3')
        decoder_input_1_to_3=nn.MaxPool3d(4,stride=4,ceil_mode=True)(hx1)
        decoder_input_2_to_3=nn.MaxPool3d(2,stride=2,ceil_mode=True)(hx2)
        decoder_input_3_to_3=hx3
        decoder_input_4_to_3=_upsample_like_for_3D(hx4d,hx3)
        decoder_input_5_to_3=_upsample_like_for_3D(hx5d,hx3)
        decoder_input_6_to_3=_upsample_like_for_3D(hx6,hx3)



        ###print(decoder_input_1_to_3.shape)
        ###print(decoder_input_2_to_3.shape)
        ###print(decoder_input_3_to_3.shape)
        ###print(decoder_input_4_to_3.shape)
        ###print(decoder_input_5_to_3.shape)
        ###print(decoder_input_6_to_3.shape)

        stage3d_input=hx3+decoder_input_1_to_3+decoder_input_2_to_3+decoder_input_4_to_3+decoder_input_5_to_3+decoder_input_6_to_3
        ###print('stage3d_input.shape',stage3d_input.shape)
        hx3d = self.stage3d(stage3d_input)
        ###print('hx3d.shape:',hx3d.shape)
        ...
        ###print('Stage 2')
        decoder_input_1_to_2=nn.MaxPool3d(2,stride=2,ceil_mode=True)(hx1)
        decoder_input_2_to_2=hx2
        decoder_input_3_to_2=_upsample_like_for_3D(hx3d,hx2)
        decoder_input_4_to_2=_upsample_like_for_3D(hx4d,hx2)
        decoder_input_5_to_2=_upsample_like_for_3D(hx5d,hx2)
        decoder_input_6_to_2=_upsample_like_for_3D(hx6,hx2)



        ###print(decoder_input_1_to_2.shape)
        ###print(decoder_input_2_to_2.shape)
        ###print(decoder_input_3_to_2.shape)
        ###print(decoder_input_4_to_2.shape)
        ###print(decoder_input_5_to_2.shape)
        ###print(decoder_input_6_to_2.shape)

        stage2d_input=hx2+decoder_input_1_to_2+decoder_input_3_to_2+decoder_input_4_to_2+decoder_input_5_to_2+decoder_input_6_to_2
        ###print('stage2d_input.shape',stage2d_input.shape)
        hx2d = self.stage2d(stage2d_input)
        ###print('hx2d.shape:',hx2d.shape)
        ...
        decoder_input_1_to_1=hx1
        decoder_input_2_to_1=_upsample_like_for_3D(hx2d,hx1)
        decoder_input_3_to_1=_upsample_like_for_3D(hx3d,hx1)
        decoder_input_4_to_1=_upsample_like_for_3D(hx4d,hx1)
        decoder_input_5_to_1=_upsample_like_for_3D(hx5d,hx1)
        decoder_input_6_to_1=_upsample_like_for_3D(hx6,hx1)



        ###print(decoder_input_1_to_1.shape)
        ###print(decoder_input_2_to_1.shape)
        ###print(decoder_input_3_to_1.shape)
        ###print(decoder_input_4_to_1.shape)
        ###print(decoder_input_5_to_1.shape)
        ###print(decoder_input_6_to_1.shape)

        stage1d_input=hx1+decoder_input_2_to_1+decoder_input_3_to_1+decoder_input_4_to_1+decoder_input_5_to_1+decoder_input_6_to_1
        ###print('stage1d_input.shape',stage1d_input.shape)
        hx1d = self.stage1d(stage1d_input)
        ###print('hx1d.shape:',hx1d.shape)
        ###print("#"*50)
...
'''
model=U2NETP_in_UNET3_PLUS_style_for_3D(in_ch=1,out_ch=1,cus_ch=128,mid_ch=16).float().cuda()
model=model.eval()
...
torch.save(model.state_dict(), 'U2NETP_in_UNET3_PLUS_style_for_3D.pth')
'''

class U2NETP_in_UNET3_PLUS_style_for_3D_with_Concat(nn.Module):

    def __init__(self,in_ch=1,out_ch=1,mid_ch=16,cus_ch=64):
        super(U2NETP_in_UNET3_PLUS_style_for_3D_with_Concat,self).__init__()
        ...
        # decoder
        self.stage5d = RSU4F_for_3D(6*cus_ch,mid_ch,cus_ch)
        self.stage4d = RSU4_for_3D(6*cus_ch,mid_ch,cus_ch)
        self.stage3d = RSU5_for_3D(6*cus_ch,mid_ch,cus_ch)
        self.stage2d = RSU6_for_3D(6*cus_ch,mid_ch,cus_ch)
        self.stage1d = RSU7_for_3D(6*cus_ch,mid_ch,cus_ch)
    ...
    def forward(self,x):
        ...
        # stage5d_input=hx5+decoder_input_1_to_5+decoder_input_2_to_5+decoder_input_3_to_5+decoder_input_4_to_5+decoder_input_6_to_5
        stage5d_input=torch.cat((hx5,decoder_input_1_to_5,decoder_input_2_to_5,decoder_input_3_to_5,decoder_input_4_to_5,decoder_input_6_to_5),1)
        ##print('stage5d_input.shape',stage5d_input.shape)
        ...
        # stage4d_input=hx4+decoder_input_1_to_4+decoder_input_2_to_4+decoder_input_3_to_4+decoder_input_5_to_4+decoder_input_6_to_4
        stage4d_input=torch.cat((hx4,decoder_input_1_to_4,decoder_input_2_to_4,decoder_input_3_to_4,decoder_input_5_to_4,decoder_input_6_to_4),1)
        ...
        # stage3d_input=hx3+decoder_input_1_to_3+decoder_input_2_to_3+decoder_input_4_to_3+decoder_input_5_to_3+decoder_input_6_to_3
        stage3d_input=torch.cat((hx3,decoder_input_1_to_3,decoder_input_2_to_3,decoder_input_4_to_3,decoder_input_5_to_3,decoder_input_6_to_3),1)
        ...
        # stage2d_input=hx2+decoder_input_1_to_2+decoder_input_3_to_2+decoder_input_4_to_2+decoder_input_5_to_2+decoder_input_6_to_2
        stage2d_input=torch.cat((hx2,decoder_input_1_to_2,decoder_input_3_to_2,decoder_input_4_to_2,decoder_input_5_to_2,decoder_input_6_to_2),1)
        ##print('stage2d_input.shape',stage2d_input.shape)
        ...
        # stage1d_input=hx1+decoder_input_2_to_1+decoder_input_3_to_1+decoder_input_4_to_1+decoder_input_5_to_1+decoder_input_6_to_1
        stage1d_input=torch.cat((hx1,decoder_input_2_to_1,decoder_input_3_to_1,decoder_input_4_to_1,decoder_input_5_to_1,decoder_input_6_to_1),1)
        ...
        return d0,d1,d2,d3,d4,d5,d6
'''
model=U2NETP_in_UNET3_PLUS_style_for_3D_with_Concat(in_ch=1,out_ch=1,cus_ch=64,mid_ch=16).float().cuda()
model=model.eval()
...
class U2NETP_along_with_Half_UNET_for_3D(nn.Module):

    def __init__(self,in_ch=1,out_ch=1):
        super(U2NETP_along_with_Half_UNET_for_3D,self).__init__()
...
#%%
# model=U2NETP_along_with_Half_UNET_for_3D(in_ch=1,out_ch=1).float().cuda()
# model=model.eval()
...
# macs, params = get_model_complexity_info(model, (1,176, 176,160), as_strings=True,
