...
experiments_folder="savedModels/Spinet_QSM_denoisers_with_unshared_weights/experiments_on_given_data/dw_WideResNet/single_patient/without_sampling/"
experiment_name="Jul_02_12_32_pm_model_K_2_given_single_patient_data_dw_WideResNet_patient_2/"
...
if(model=='deepqsm'):
    ...
    dw = U2NETP_for_3D_cus_ch(in_ch=1,out_ch=1,cus_ch=64,mid_ch=16)
elif(model == '3D_U2NETP'):
     dw = U2NETP_for_3D_cus_ch(in_ch=2,out_ch=2,cus_ch=64,mid_ch=16).cuda(device_id)
elif(model == '3D_U2NETP_32_16'):
     dw = U2NETP_for_3D_cus_ch(in_ch=2,out_ch=2,cus_ch=32,mid_ch=16).cuda(device_id)
...
# checkpoint = torch.load("/media/venkatesh/DATA/venkatesh/IISc/MIG_LAB_WORK/Experiments/QSM_venkatesh/SpiNet_QSM_with_individual_denoisers/savedModels/Spinet_QSM_denoisers_with_unshared_weights/experiments_on_given_data/dw_WideResNet/with_sampling/Jun_15_11_32_pm_model_K_3_given_data_dw_WideResNet_data_source_1_sampled_4000/model_52.pt")

#%%

print(checkpoint['K_unrolling'])
